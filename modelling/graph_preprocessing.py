...
class Integration:
    ...
    def __init__(self, goa_record, bg=False, generif=False, type='co', flag='train'):
        ...
        if bg:
            ...
            # inductively encode exGOA and GoDg into embedding
            node2embedding = GBGEmbedding(flag=flag).encode(goa_record)  # exGOA embedding
            gohier2embedding = GODAGEmbedding().encode(go_hier)  # GoDg embedding
