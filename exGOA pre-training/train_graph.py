...
class MakeGraph:
    ...
    def node_encoder(self, g):
        ...
        g.nodes['go_id'].data['h'] = torch.randn(g.num_nodes('go_id'), 8) # initialization of GO node embedding as random 8-dim vector
        g.nodes['pmid_gene'].data['h'] = torch.ones(g.num_nodes('pmid_gene'), 8) # initialization of PMG node embedding as all-one 8-dim vector
        return g
...
if __name__ == '__main__':
    ...
    try:
        ...
        print("The development set is not found, evaluation skipped")
    try:
        ...
        print("The test set is not found, evaluation skipped")
